...
/// <summary>
/// Ranged enemy that keeps distance and fires missiles that home on the player.
/// </summary>
public class HomingEnemyAI : EnemyAI
{
    ...
    [SerializeField] float projectileHeight = 0.85f;
    ...
    void FireMissile(Vector3 flatDirection)
    {
        ...
        missile.LaunchAsEnemyHoming(flatDirection, transform, Player);
